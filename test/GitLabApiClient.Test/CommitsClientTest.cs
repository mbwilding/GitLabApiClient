...
{
    private readonly CommitsClient _sut = new(
    ...
    public async Task CreateCommitRequest(bool autoEncodeToBase64)
    {
        ...
        {
            new(CreateCommitRequestActionType.Create, "file" + suffix)
            {
                Content = "content"
            }
        };
        ...
        {
            new(CreateCommitRequestActionType.Update, "file" + suffix)
            {
                Content = "new content"
            }
        };
        ...
        actions = new List<CreateCommitRequestAction>
        {
            new(CreateCommitRequestActionType.Move, "subfolder/file" + suffix)
            {
        ...
        actions = new List<CreateCommitRequestAction>
        {
            new(CreateCommitRequestActionType.Delete, "subfolder/file" + suffix)
        };

...
{
    private readonly List<int> _groupIdsToClean = new();
    private List<int> MilestoneIdsToClean { get; } = new();
    private List<string> VariableIdsToClean { get; } = new();

    private readonly GroupsClient _sut = new(
        GetFacade(),

...
{
    private readonly MergeRequestsClient mergeRequestsClient = new(GitLabApiHelper.GetFacade(), new MergeRequestsQueryBuilder(), new ProjectMergeRequestsQueryBuilder(), new ProjectMergeRequestsNotesQueryBuilder());
    private readonly IssuesClient issuesClient = new(GitLabApiHelper.GetFacade(), new IssuesQueryBuilder(), new ProjectIssueNotesQueryBuilder());


    private readonly ToDoListClient _sut = new(

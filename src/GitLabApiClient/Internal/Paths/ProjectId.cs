...
public class ProjectId
{
    ...
    /// <returns></returns>
    public static implicit operator ProjectId(string projectPath) => new(projectPath.UrlEncode());

    public static implicit operator ProjectId(int projectId) => new(projectId.ToString());
